...
export interface NodeData {
  ...
  export function createInitialGameState(): GameState {
    const nodes: NodeData[] = [
      { id: 1, adjacency: [2, 4],       owner: null, ownerColor: null, troops: 0 },
      { id: 2, adjacency: [1, 3, 5],    owner: null, ownerColor: null, troops: 0 },
      { id: 3, adjacency: [2, 6],       owner: null, ownerColor: null, troops: 0 },
      { id: 4, adjacency: [1, 5, 7],    owner: null, ownerColor: null, troops: 0 },
      { id: 5, adjacency: [2, 4, 6, 8], owner: null, ownerColor: null, troops: 0 },
      { id: 6, adjacency: [3, 5, 9],    owner: null, ownerColor: null, troops: 0 },
      { id: 7, adjacency: [4, 8],       owner: null, ownerColor: null, troops: 0 },
      { id: 8, adjacency: [5, 7, 9],    owner: null, ownerColor: null, troops: 0 },
      { id: 9, adjacency: [6, 8],       owner: null, ownerColor: null, troops: 0 },
    ];
